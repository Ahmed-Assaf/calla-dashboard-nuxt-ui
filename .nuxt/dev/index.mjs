...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/devalue/index.js';
import destr from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/node_modules/@unhead/shared/dist/index.mjs';
...
const appConfig0 = defineAppConfig({
  ui: {
    ...
    button: {
      ...
      color: {
        primary: {
          ...
          outline: "text-primaryColor bg-transparent border-2 border-primaryColor hover:text-white hover:bg-primaryColor",
        ...
        gray: {
          solid: "text-base bg-strokeLightGray border-none ring-0 hover:bg-transparent"
        },
        red: {
    ...
    input: {
      ...
      color: {
        white: {
          outline: "shadow-none text-textLightColor ring-strokeLightGray focus:ring-1 focus:ring-primaryColor dark:focus:ring-primaryColor"
        }
      },
      variant: {
...
const serverAssets = [{"baseName":"server","dir":"F:/My files/Front end/Projects/calla-dashboard-nuxt-ui/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\My files\\Front end\\Projects\\calla-dashboard-nuxt-ui","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\My files\\Front end\\Projects\\calla-dashboard-nuxt-ui\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\My files\\Front end\\Projects\\calla-dashboard-nuxt-ui\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\My files\\Front end\\Projects\\calla-dashboard-nuxt-ui\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"F:\\My files\\Front end\\Projects\\calla-dashboard-nuxt-ui\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9ceg5hbjxw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "F:/My files/Front end/Projects/calla-dashboard-nuxt-ui";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _KrOxAbgIib = (nitroApp) => {
...
const _TT1EULsawJ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_r6qCnV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_r6qCnV, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_r6qCnV, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://F:/My%20files/Front%20end/Projects/calla-dashboard-nuxt-ui/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
